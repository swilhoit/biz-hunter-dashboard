...
CREATE TABLE deals (
  ...
  search_vector tsvector GENERATED ALWAYS AS (
    ...
    setweight(to_tsvector('english', coalesce(array_to_string(dba_names, ' '), '')), 'B') ||
...
-- Execute migration (commented out for safety - run manually when ready)
-- SELECT migrate_favorites_to_deals();
