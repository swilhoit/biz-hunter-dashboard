...
function FintechCard02() {
  return (
    <div className="flex flex-col col-span-full xl:col-span-4 bg-[linear-gradient(225deg,var(--tw-gradient-stops))] from-gray-800 to-gray-900 shadow-sm rounded-xl">
