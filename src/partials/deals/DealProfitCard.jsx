...
function DealProfitCard() {
  ...
  const chartData = {
    ...
    datasets: [
      // Profit line
      {
        data: [2480, 2640, 2960, 3220, 3180, 3440, 3720, 3960, 4240, 4160, 4420, 4700, 4840],
        fill: true,
      ...
      // Previous year
      {
        data: [1640, 1820, 1780, 2040, 1960, 2280, 2420, 2640, 2960, 2780, 3040, 3220, 3640],
    ...
    <div className="flex flex-col col-span-full sm:col-span-6 xl:col-span-4 bg-white dark:bg-gray-800 shadow-sm rounded-xl">
      <div className="px-5 pt-5">
        <header className="flex justify-between items-start mb-2">
          <h2 className="text-lg font-semibold text-gray-800 dark:text-gray-100 mb-2">Expected Profit</h2>
        ...
        <div className="text-xs font-semibold text-gray-400 dark:text-gray-500 uppercase mb-1">Annual Profit Potential</div>
        <div className="flex items-start">
          <div className="text-3xl font-bold text-gray-800 dark:text-gray-100 mr-2">$4.84M</div>
          <div className="text-sm font-medium text-blue-700 px-1.5 bg-blue-500/20 rounded-full">+33%</div>
        </div>
      </div>
