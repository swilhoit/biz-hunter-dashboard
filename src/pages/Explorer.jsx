...
import { Search, TrendingUp, Package, BarChart3, Settings, Filter, Download, AlertCircle } from 'lucide-react';
...
function ExplorerContent() {
  ...
  // Handle product search using JungleScout API
  ...
  }, [keywords, settings.marketplace, setIsLoading, setError]);
      ...
      <div className="relative flex flex-col flex-1 overflow-y-auto overflow-x-hidden">
        ...
        <main className="grow">
          <div className="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
            <div className="mb-8">
              <h1 className="text-2xl md:text-3xl text-gray-800 dark:text-gray-100 font-bold">Market Explorer</h1>
              <p className="text-gray-600 dark:text-gray-400">Research Amazon FBA market opportunities and trends</p>
            </div>
            ...
            <div className="mb-6 space-y-4">
              ...
              <div className="flex items-center gap-4">
                <label className="flex items-center gap-2 cursor-pointer">
                  ...
                  <label 
                    htmlFor="csv-upload" 
                    className="px-4 py-2 border border-gray-300 dark:border-gray-700 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700 cursor-pointer flex items-center gap-2"
                  >
            ...
            <Tabs value={activeTab} onValueChange={setActiveTab}>
                  ...
                  <div className="bg-white dark:bg-gray-800 rounded-lg shadow p-8 text-center">
                    ...
                    <p className="text-gray-500 dark:text-gray-400">
                      {searchResults.length > 0 
                        ...
                        : 'Enter keywords above to search for Amazon products or upload a CSV file'}
                    </p>
                  </div>
                )}
              </TabsContent>
              ...
              <TabsContent value="trends">
                {filteredResults.length > 0 ? (
                    ...
                    <div className="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                        <div className="p-4 bg-gray-50 dark:bg-gray-700/50 rounded-lg">
                          <p className="text-sm text-gray-500 dark:text-gray-400">Top Brand</p>
                          <p className="text-lg font-semibold text-gray-800 dark:text-gray-100">
                            {(() => {
                              const brandCounts = filteredResults.reduce((acc, product) => {
                                const brand = product.brand || 'Unknown';
                                acc[brand] = (acc[brand] || 0) + 1;
                                return acc;
                              }, {});
                              const topBrand = Object.entries(brandCounts).sort(([,a], [,b]) => b - a)[0];
                              return topBrand ? `${topBrand[0]} (${topBrand[1]})` : 'N/A';
                            })()}
                          </p>
                        </div>
                        <div className="p-4 bg-gray-50 dark:bg-gray-700/50 rounded-lg">
                          <p className="text-sm text-gray-500 dark:text-gray-400">Avg Revenue per Product</p>
                          <p className="text-lg font-semibold text-gray-800 dark:text-gray-100">
                            ${Math.round(filteredResults.reduce((sum, p) => sum + p.revenue, 0) / filteredResults.length).toLocaleString()}
                          </p>
                        </div>
                        <div className="p-4 bg-gray-50 dark:bg-gray-700/50 rounded-lg">
                          <p className="text-sm text-gray-500 dark:text-gray-400">Highest Sales Product</p>
                          <p className="text-lg font-semibold text-gray-800 dark:text-gray-100">
                            {Math.max(...filteredResults.map(p => p.sales)).toLocaleString()} units
                          </p>
                        </div>
                      </div>
                    </div>
                  ...
                  <div className="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
                    <h3 className="text-lg font-semibold mb-4 text-gray-800 dark:text-gray-100">Market Trends</h3>
                    <p className="text-gray-600 dark:text-gray-400">
