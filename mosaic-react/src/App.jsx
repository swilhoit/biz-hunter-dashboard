...
function App() {
  ...
  return (
    <>
      <Routes>
        <Route exact path="/" element={<DealPipeline />} />
        ...
        <Route path="/deals/ai-analysis" element={<AIAnalysis />} />
        <Route path="/deals/comparison" element={<DealComparison />} />
        <Route path="/deals/asin-tracker" element={<ASINTracker />} />
        <Route path="/deals/documents" element={<DocumentManager />} />
