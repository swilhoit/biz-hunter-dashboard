...
function DealTasksCard() {
  ...
  const tasks = [
    {
      id: 1,
      title: 'Review financial statements for Kitchen Gadgets Pro',
      priority: 'high',
      dueDate: 'Today',
      assignee: 'Sarah Chen',
      completed: false
    ...
    {
      id: 2,
      title: 'Schedule call with Pet Supplies Direct owner',
      priority: 'medium',
      dueDate: 'Tomorrow',
    ...
    {
      id: 3,
      title: 'Complete market analysis for Beauty Essentials',
      priority: 'high',
      dueDate: 'Dec 15',
    ...
    {
      id: 4,
      title: 'Upload LOI for Outdoor Adventure Co',
      priority: 'low',
      dueDate: 'Dec 18',
