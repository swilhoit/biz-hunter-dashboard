...
import CRMPipeline from "./pages/dashboard/CRMPipeline";
import CRMAnalytics from "./pages/dashboard/CRMAnalytics";
        ...
        <BrowserRouter>
          <Routes>
            ...
            <Route path="/" element={<DashboardLayout />}>
              ...
              <Route path="dashboard/crm" element={<CRMPipeline />} />
              <Route path="dashboard/crm/analytics" element={<CRMAnalytics />} />
              <Route path="dashboard/crm/deal/:dealId" element={<DealDetail />} />
